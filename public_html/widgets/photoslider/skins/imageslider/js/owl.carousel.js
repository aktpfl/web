...
/* 
 *  edit :orangetree 
 *  OwlCarousel을 autoplay하지 않고 마우스 하버에만 움직이도록 수정.
 *
 */
...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		...
		calculateWidth : function(){
			var base = this;
			var $outer = base.$elem.find(".owl-wrapper-outer");
...
/*			base.buttonPrev = $("<div/>",{
			...
			base.buttonNext = $("<div/>",{
				...
				base.buttonPrev = $("<div/>",{
				"class" : "owl-prev",
				"html" :"<img src=\""+base.options.navigationPath+"prev.png \"/>"
				});
				base.buttonNext = $("<div/>",{
				"class" : "owl-next",
				"html" :"<img src=\""+base.options.navigationPath+"next.png \"/>"
				});/*euna*/
			...
			buttonsWrapper.on("touchstart.owlControls click.owlControls", "div[class^=\"owl\"]", function(event){//euna
