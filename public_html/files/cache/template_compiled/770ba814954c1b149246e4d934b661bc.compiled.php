<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/xe_v3_gallery_haan/xe_v3_gallery.css--><?php $__tmp=array('modules/board/skins/xe_v3_gallery_haan/xe_v3_gallery.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/xe_v3_gallery_haan/xe_v3_gallery.js--><?php $__tmp=array('modules/board/skins/xe_v3_gallery_haan/xe_v3_gallery.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<div class="xev3gallery">
	...
	<?php if($__Context->module_info->use_category=='Y'){ ?><ul class="cTab">
		<li<?php if(!$__Context->category){ ?> class="on"<?php } ?>><a href="<?php echo getUrl('','mid',$__Context->mid) ?>"><?php echo $__Context->lang->total ?></a></li>
