...
$__Context->mi = $__Context->module_info;
 ...
 ?>
<!--#Meta:modules/board/skins/xe_v3_gallery_haan/js/jquery.easing.1.3.js--><?php $__tmp=array('modules/board/skins/xe_v3_gallery_haan/js/jquery.easing.1.3.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/xe_v3_gallery_haan/js/list.xe.js--><?php $__tmp=array('modules/board/skins/xe_v3_gallery_haan/js/list.xe.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<div class="list">
		...
		<fieldset>
			...
			<ul>
				<li class="fbox article">
					...
					<span class="thumb">
						<img src="/modules/board/skins/xe_v3_gallery_haan/img/noimage.gif" width="<?php echo $__Context->mi->thumbnail_width ?>" height="<?php echo $__Context->mi->thumbnail_height ?>" alt="" /></a>
					</span>
			...
			<ul>
				<?php if($__Context->document_list&&count($__Context->document_list))foreach($__Context->document_list as $__Context->doc){ ?><li class="fbox article <?php echo ($__Context->list_idx++%2)?'odd':'even' ?>" >
					...
					<span class="thumb">
					<a href="<?php echo $__Context->post_link ?>" class="title">
					...
					<?php }else{ ?>
						<img src="/modules/board/skins/xe_v3_gallery_haan/img/noimage.gif" width="<?php echo $__Context->mi->thumbnail_width ?>" height="<?php echo $__Context->mi->thumbnail_height ?>" alt="" />
					<?php } ?>
					</a>
					</span>
					<ul class="flat meta" style="width:<?php echo $__Context->mi->thumbnail_width ?>px;">
						<li  class="title"> <a href="<?php echo $__Context->post_link ?>"><?php echo $__Context->doc->getTitle($__Context->mi->subject_cut_size) ?> <!--<?php echo $__Context->doc->printExtraImages(60*60*$__Context->module_info->duration_new) ?>--><span class="iefix"></span></a></li>
