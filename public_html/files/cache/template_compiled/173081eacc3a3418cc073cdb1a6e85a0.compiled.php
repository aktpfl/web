...
<section>
	<ul class="x_nav x_nav-tabs">
		<li class="x_active"><a href="<?php echo escape(getUrl('','module','admin','act','dispSpamfilterAdminDeniedIPList'), false) ?>"><?php echo $__Context->lang->cmd_denied_ip ?></a></li>
		<li><a href="<?php echo escape(getUrl('','module','admin','act','dispSpamfilterAdminDeniedWordList'), false) ?>"><?php echo $__Context->lang->cmd_denied_word ?></a></li>
		<li><a href="<?php echo escape(getUrl('','module','admin','act','dispSpamfilterAdminConfigBlock'), false) ?>"><?php echo $__Context->lang->cmd_config_block ?></a></li>
	</ul>
		...
		<table class="x_table x_table-striped x_table-hover">
			...
			<tbody>
				<?php if($__Context->ip_list&&count($__Context->ip_list))foreach($__Context->ip_list as $__Context->ip_info){ ?><tr>
					<td><?php echo escape($__Context->ip_info->ipaddress, false) ?></td>
					<td><?php echo escape($__Context->ip_info->description, false) ?></td>
					<td><?php echo escape(zdate($__Context->ip_info->regdate,'Y-m-d'), false) ?></td>
					<td><input type="checkbox" name="ipaddress[]" value="<?php echo escape($__Context->ip_info->ipaddress, false) ?>" /></td>
				</tr><?php } ?>
