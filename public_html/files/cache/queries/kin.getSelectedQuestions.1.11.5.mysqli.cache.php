...
,new SelectExpression('`kin`.`selected`', '`selected`')
));
...
,new ConditionWithoutArgument('`kin`.`document_srl`','`doc`.`document_srl`',"equal", 'and')
,new ConditionWithoutArgument('`kin`.`selected`','0',"more", 'and')))
,new ConditionGroup(array(
new ConditionWithArgument('`doc`.`category_srl`',$category_srl2_argument,"in")
