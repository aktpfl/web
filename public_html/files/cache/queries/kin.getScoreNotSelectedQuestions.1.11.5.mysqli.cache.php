...
$query = new Query();
$query->setQueryId("getScoreNotSelectedQuestions");
...
${'sort_index6_argument'}->ensureDefaultValue('point.point');
...
,new JoinTable('`xe_kin_point`', '`point`', "left join", array(
new ConditionGroup(array(
new ConditionWithoutArgument('`doc`.`document_srl`','`point`.`document_srl`',"equal")))
))
));
